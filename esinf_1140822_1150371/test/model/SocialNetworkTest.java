...
//    }
    ...
    public void testShortestPathMostFriendsCity() throws FileNotFoundException, IOException {
        ...
        expResult.add(instance.getListOfCities().getCityByName("city2"));
        expResult.add(instance.getListOfCities().getCityByName("city7"));
        expResult.add(instance.getListOfCities().getCityByName("city5"));
        expResult.add(instance.getListOfCities().getCityByName("city7"));
        expResult.add(instance.getListOfCities().getCityByName("city4"));
